        ...
        <div className="font-mono text-[10px] tracking-wider text-right flex items-center gap-1.5" style={{ color: CREAM_DIM }}>
          ...
          {(() => {
            ...
            if (details.amount == null) {
              return (
                <>
                  ...
                  <span style={{ color: CREAM_DIM }} title={priceTooltip(details)}>
                    {formatPrice(null, cur)}
                  </span>
                </>
              );
            }
            return (
              <>
                <span className="opacity-50">·</span>
                <span style={{ color: CREAM }} title={priceTooltip(details)}>
                  {details.approximate ? '~' : ''}{formatPrice(details.amount, cur)}
                </span>
              </>
            );
          })()}
